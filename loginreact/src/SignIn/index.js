...
import Portada from '../Head/carrusel';
     ...
     <div > 
       ...
       <SignUpLink />
        ...
        <div style={{padding:"20px 20px 0px 0px"}}>
          <Popup  content='Regresar a landing principal' trigger={<a href='/'><Icon circular name='home'/></a>}/>
        </div>
    ...
    return (
      <form className="needs-validation" novalidate onSubmit={this.onSubmit}>
        ...
        <div className="form-row">
         ...
         <Button type="button"  color='green' animated type="submit" disabled={isInvalid} style={{padding:10}} >
           <Button.Content visible > <Icon name='mail' />Sign with Email</Button.Content>
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit} style={{padding:"10px 0px 10px 0px"}}>
        ...
        <Button basic color='red' animated type="submit" style={{padding:10}} >
           <Button.Content visible  src="../../../imagenes2/go.png" > <Icon name='google' />Sign with Google</Button.Content>
            <Button.Content hidden>
               <Icon name='google' />
               <Icon name='sign-in'/>
            </Button.Content>
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit} style={{padding:"10px 0px 10px 0px"}}>
        ...
        <Button basic color='blue' animated type="submit" style={{padding:10}} >
           <Button.Content visible  src="../../../imagenes2/go.png" > <Icon name='facebook' />Sign with Facebook</Button.Content>
            <Button.Content hidden>
               <Icon name='facebook' />
               <Icon name='sign-in'/>
            </Button.Content>
