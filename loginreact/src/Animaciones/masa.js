...
class Masa extends Component {
  componentDidMount() {
    window.onload = function() {
      var close = (document.getElementById("close").onmousedown = function(e) {
        e.preventDefault();
    ...
    var fluid = (function() {
      ...
      var process_image = function process_image() {
      ...
      var run = function run() {
        ...
        if (mouse.down) {
          ...
          ctx.closePath();
          ctx.fill();
        } else ctx.canvas.style.cursor = "default"; //console.log(new Date().getTime() - time);

        if (play) requestAnimationFrame(run);
      };

      var Particle = function Particle(type, x, y) {
        this.type = type;
        this.x = x;
        this.y = y;
        this.px = x;
    ...
    var reset = (document.getElementById("reset").onmousedown = function() {
      fluid.stop();
      setTimeout(function() {
